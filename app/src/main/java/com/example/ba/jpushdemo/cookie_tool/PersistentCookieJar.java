...
package com.example.ba.jpushdemo.cookie_tool;


import android.util.Log;


import com.example.ba.jpushdemo.cookie_tool.cache.CookieCache;
import com.example.ba.jpushdemo.cookie_tool.cache.SetCookieCache;
import com.example.ba.jpushdemo.cookie_tool.persistence.CookiePersistor;
...
public class PersistentCookieJar implements ClearableCookieJar {
    ...
    //将这一次会话的东西去掉，不然会用上一次的会话，这样加载数据的时候会出问题
    public void reset(){
        cache.clear();
